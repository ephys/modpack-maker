...
import { Field, ObjectType, registerEnumType } from '../esm-compat/nest-graphql-esm.js';
...
function SuccessOnlyPayload<Node>(name: string, NodeType: Type2<Node>): Type<IPayloadType<Node, never>> {
  ...
  return PayloadType as unknown as Type<IPayloadType<Node, never>>;
}
...
export { Payload, type IPayloadType, type IPayloadError };
